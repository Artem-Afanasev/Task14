...
public class HelloController implements Initializable {
    ...
    public boolean init(){
        ...
        if(! player1.pay(1)) {
            ...
            alert.setHeaderText("Средств на счете недостаточно, нужна монета!");

            alert.show();

        //    action=null;

            //view1.setImage(new Image("монетка.jpg"));
    ...
    public void statusShow() {
        ...
        Wins.setText(player1.getWins().toString());
        Loss.setText(player1.getLoss().toString());
    }
